...
<html>
  ...
  <body onload="load()">
	...
	<div id="help" style="display: block;">
		...
		<div style="font-size:8pt; margin-top: 3px;">* Οι ονομασίες των χωρών προέρχονται από τη βάση δεδομένων της Google και δεν έχουμε ουδεμία ευθύνη για το περιεχόμενο τους</div>
	</div>
    ...
    <script type="text/javascript">		
		...
		function createMarker5(id,username,email,facebook,ddate,hour,people,direction,details,point1,point2,status,radius,name,everyday) {
			...
			if (everyday == "true") {
				txt = '<div style="font-weight:bold" align="center"><u><b>Καθημερινό δρομολόγιο</b></u></div>' + txt;
			}
			if(direction == "Οδηγός") {
				directionsDisplay.setMap(null);
